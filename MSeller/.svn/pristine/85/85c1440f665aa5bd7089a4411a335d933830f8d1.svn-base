//
//  YGAutoRefreshFooter.m
//  mobile
//
//  Created by xk on 16/2/29.
...
- (void)placeSubviews
{
    ...
    self.logo.frame = CGRectMake(CGRectGetWidth(self.frame)*0.5-Logo_Img_WH-10.f-20.f, (CGRectGetHeight(self.frame)-Logo_Img_WH)*0.5, Logo_Img_WH, Logo_Img_WH);
    ...
    self.label.frame = CGRectMake(CGRectGetWidth(self.frame)*0.5-20.f, 0.f, CGRectGetWidth(self.frame)*0.5, CGRectGetHeight(self.frame));
