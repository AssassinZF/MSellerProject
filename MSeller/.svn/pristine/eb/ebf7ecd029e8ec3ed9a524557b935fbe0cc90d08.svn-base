...
{
    ScalableCover *cover = [[ScalableCover alloc] initWithFrame:CGRectMake(0, 0, Screen_Width, height)];
...
- (void)layoutSubviews
{
    ...
    if (self.scrollView.contentOffset.y < 0)
    {
        ...
        self.frame = CGRectMake(-offset/2, -offset, _width + offset, _height + offset);
    }
    else
    {
        self.frame = CGRectMake(0, 0, _scrollView.bounds.size.width, _height);
    }
}
